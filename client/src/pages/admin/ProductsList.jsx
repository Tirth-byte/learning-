...
import { Table, Tag, Typography, Card, Button, Input, Space, Modal, Form, Select, message, Popconfirm, Badge, Tooltip, Row, Col } from 'antd';
import { SearchOutlined, EditOutlined, DeleteOutlined, PlusOutlined, GlobalOutlined, ToolOutlined, PieChartOutlined } from '@ant-design/icons';
    ...
    <div className="fadeIn-animation" style={{ padding: '0 8px 24px 8px', backgroundColor: '#F5F6F8' }}>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleSubmit} style={{ marginTop: 16 }}>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item name="salesPrice" label="Rental Rate" rules={[{ required: true, message: 'Rate is required' }]}>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item name="securityDeposit" label="Security Deposit" rules={[{ required: true, message: 'Deposit is required' }]}>
                <Input type="number" step="0.01" prefix="₹" />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item name="lateFeePerHour" label="Late Fee / Hour" rules={[{ required: true, message: 'Late fee is required' }]}>
                <Input type="number" step="0.01" prefix="₹" />
              </Form.Item>
            </Col>
          </Row>

          <Form.Item name="qtyOnHand" label="Stock Quantity (Qty on Hand)" rules={[{ required: true, message: 'Stock count is required' }]}>
            <Input type="number" />
          </Form.Item>
